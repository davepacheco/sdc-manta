...
var AmonConfiguration = require('./amon_config');
 ...
 *
 * "callback" is invoked as "callback(err, amoncfg)", with the usual convention
 * that exactly one of "err" or "results" will be valid.  If "err" is null, then
 * "amoncfg" will be an instance of the separate AmonConfiguration class.
 *
...
{
	var client, queue, errors, progress, ndone;
	var amoncfg;
